		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" style="padding-top:55px;">
					<span class="login100-form-title p-b-43" style="font-weight:bold;">
					...
					<div style="width:100%">
						<ul style="list-style:none; margin:0; padding:0;">
							...
							<li style="margin-left:30px; float: left; text-align: center;"><img src="${path}resources/images_member/edit_blue.png" width="45px" style="margin-bottom:5px;"><br/><span style="color:#6675df; font-weight:bold;">3.정보입력</span></li>
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="text" name="email">
						<span class="focus-input100"></span>
						<span class="label-input100">로그인시사용할아이디치는곳</span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate="Password is required">
						<input class="input100" type="password" name="pass">
						<span class="focus-input100"></span>
						<span class="label-input100">비밀번호 확인하는 곳</span>
					</div>
